...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    decorate_tool_logo_svgs();
});

function decorate_tool_logo_svgs(){
	const toollogos = document.querySelectorAll('.pfi__toollogo svg');	
	for(logo of toollogos){
		draw_multiple_svg_paths(logo, {fillStyle: 'solid', fill: '#fff', stroke: '#333' , roughness: '1.5', strokeWidth: '2', simplification: 5})
	}
}
...
function decorate_menuitem_hoverstates() {
...
class imageFrame {
    ...
    framePic() {
        ...
        function do_caption_styling(p) {
            ...
            const opts = { fillStyle: 'solid', fill: '#222', roughness: 2, bowing: 2, strokeWidth: 1.5, stroke: '#eee' };
